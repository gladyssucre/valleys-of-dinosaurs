...
dino4 = Dinosaur.create!( { name: "M", age: rand(100), image_url: "https://goo.gl/aoZsYt" } )
dino5 = Dinosaur.create!( { name: "Hungarosaurus", age: rand(100), image_url: "https://goo.gl/EqRlgP" } )
